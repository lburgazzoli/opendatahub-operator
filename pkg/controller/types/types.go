...
type ControllerManager interface {
	...
	IsTypedObject(s schema.GroupVersionKind) bool

	IsUnstructuredObject(s schema.GroupVersionKind) bool

	GetCacheForType(s schema.GroupVersionKind) cache.Cache

	Source(obj client.Object, eh handler.EventHandler, predicates ...predicate.Predicate) source.Source
}
